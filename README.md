...
- Pushing a `v*` tag runs the release workflow, verifies the repo again, creates a GitHub release, and publishes to npm through GitHub Actions trusted publishing.

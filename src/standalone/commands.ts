...
export const STANDALONE_SLASH_COMMANDS: StandaloneSlashCommand[] = [
  ...
  { name: "settings", description: "open Pi settings menu", kind: "pi-builtin", supported: false },
  { name: "scoped-models", description: "enable/disable models for Ctrl+P cycling", kind: "pi-builtin", supported: false },
